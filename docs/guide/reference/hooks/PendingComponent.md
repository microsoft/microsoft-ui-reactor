...
Component backing the `Pending` element. Hosts a [PendingScope](PendingScope.md) ([guide](../../hooks.md)),
...
the child's `Visibility` is flipped to `Collapsed` and the fallback is
