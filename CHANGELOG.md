...
- **The Visual Studio preview now supports packaged (MSIX) apps** that use the Windows App
  SDK run support (`Microsoft.Windows.SDK.BuildTools.WinApp`). Previewing one previously
  failed. (PR #1282)
