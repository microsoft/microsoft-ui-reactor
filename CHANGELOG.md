...
- **Packaged (MSIX) apps now work in the Visual Studio preview.** The Reactor templates
  generate a packaged app by default, and previewing one previously failed. It now works
  with no project changes. (PR #1282)
