...
name: reactor-forms
description: >
  Forms, validation, and controlled inputs in Reactor — UseValidationContext,
  built-in validators, FormField helper, masked input, input formatters.
  Load this when building form UIs, validation flows, or data-entry screens.
---
