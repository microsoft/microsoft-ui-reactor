...
**Prerequisite:** A Figma MCP server must be configured (e.g., `figma-developer-mcp`). See [spec 033](../docs/specs/033-figma-to-reactor.md) for the full workflow architecture.
...
8. Agent scaffolds project if needed (`patch.exe --create`)
