...
class SceneAIde : Component
{
    ...
    private static Element EditorPane(string banner, string initial) =>
        Memo(ctx =>
        {
            ...
            return VStack(6,
                ...
                TextBox(text, setText, placeholderText: "edit me…")
            ).Padding(12);
        });
    ...
    private static Element FilterPane(string banner, string filterPlaceholder, string[] items) =>
        Memo(ctx =>
        {
            ...
            return VStack(4,
                TextBlock(banner).SemiBold(),
                TextBox(filter, setFilter, placeholderText: filterPlaceholder),
    ...
    private static Element GitChangesPane() =>
        Memo(ctx =>
        {
            ...
            return VStack(6,
                ...
                TextBox(message, setMessage, placeholderText: "Describe the change…")
