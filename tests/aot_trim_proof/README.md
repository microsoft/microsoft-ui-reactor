...
dotnet test --project tests/aot_trim_proof/Reactor.AotHelloWorld.TrimAssertions --nologo
```
...
dotnet test --project tests/aot_trim_proof/Reactor.AotHelloWorld.Advanced.TrimAssertions --nologo
...
dotnet test --project tests/aot_trim_proof/Reactor.AotHelloWorld.Advanced.Positive.TrimAssertions --nologo
```
