...
dotnet test --project tests/aot_trim_proof/Reactor.AotHelloWorld.TrimAssertions --no-banner
```
...
dotnet test --project tests/aot_trim_proof/Reactor.AotHelloWorld.Advanced.TrimAssertions --no-banner
...
dotnet test --project tests/aot_trim_proof/Reactor.AotHelloWorld.Advanced.Positive.TrimAssertions --no-banner
```
