...
public class Md4cWikiLinksTest
{
    ...
    public void Example_0001()
    {
        ...
        var actual = Md4cTestHelper.SpecToHtml(md, MarkdownParserFlags.WikiLinks);
    ...
    public void Example_0016()
    {
        ...
        var actual = Md4cTestHelper.SpecToHtml(md, MarkdownParserFlags.WikiLinks | MarkdownParserFlags.Tables);
        Assert.Equal(Md4cTestHelper.NormalizeHtml(expected), Md4cTestHelper.NormalizeHtml(actual));
    }
