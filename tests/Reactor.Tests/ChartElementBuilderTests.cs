...
public class ChartElementBuilderTests
{
    ...
    {
        var tree = Charts.TreeChart(SampleTree, n => n.Children, n => n.Name);
        Assert.NotNull(tree);
    }
    ...
    {
        var tree = Charts.TreeChart(SampleTree, n => n.Children)
    ...
    {
        var pie = Charts.PieChart(PieData, d => d.Value)
    ...
    {
        var pie = Charts.PieChart(PieData, d => d.Value, d => d.Label)
            .Width(500)
            .Height(500)
            .InnerRadius(100)
            .PadAngle(0.03)
