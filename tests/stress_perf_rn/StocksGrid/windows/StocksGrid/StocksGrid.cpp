// StocksGrid.cpp : Defines the entry point for the application.
//
// Modified for stress-perf benchmarking:
//   • Parses our --headless / --percent / --duration / --count CLI flags
...
struct CliArgs {
  ...
  int count = 5000;          // VirtualList only
};
...
_Use_decl_annotations_ int CALLBACK WinMain(HINSTANCE instance, HINSTANCE, PSTR /* commandLine */, int showCmd) {
  ...
  viewOptions.ComponentName(L"StocksGrid");
